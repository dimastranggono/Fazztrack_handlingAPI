...
import 'package:fazztrack_getx_statemanagement/Home.dart';
import 'package:fazztrack_getx_statemanagement/stateGetX.dart';
...
class _FirstPageState extends State<FirstPage> {
  // stateGetX controller = Get.put(stateGetX());
